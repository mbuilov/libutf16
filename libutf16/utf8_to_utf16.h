...
#define ANNS_UTF8_TO_UTF16_Z_(oa) \
A_Check_return \
A_Nonnull_arg(1) \
...
#define TEMPL_UTF8_TO_UTF16_Z_(name, ot, oa) \
ANNS_UTF8_TO_UTF16_Z_(A_##oa) \
size_t name( \
...
TEMPL_UTF8_TO_UTF16_Z_(utf8_to_utf16_z_, utf16_char_t, Post_z);
TEMPL_UTF8_TO_UTF16_Z_(utf8_to_utf16x_z_, utf16_char_t, Post_z);
TEMPL_UTF8_TO_UTF16_Z_(utf8_to_utf16u_z_, utf16_char_unaligned_t, Empty);
TEMPL_UTF8_TO_UTF16_Z_(utf8_to_utf16ux_z_, utf16_char_unaligned_t, Empty);

#undef ANNS_UTF8_TO_UTF16_Z_
...
#undef ANNS_UTF8_TO_UTF16
#undef TEMPL_UTF8_TO_UTF16
...
#ifdef SAL_DEFS_H_INCLUDED /* include "sal_defs.h" for the annotations */
#define ANNS_UTF8_TO_UTF16_Z_UNSAFE(oa) \
A_Nonnull_all_args \
A_Ret_never_null \
A_At(q, A_In_z) \
...
#define TEMPL_UTF8_TO_UTF16_Z_UNSAFE(name, ot, oa) \
ANNS_UTF8_TO_UTF16_Z_UNSAFE(A_##oa) \
const utf8_char_t *name( \
	const utf8_char_t *q/*!=NULL,0-terminated*/, \
	ot/*utf16_char_t,utf16_char_unaligned_t*/ buf[]/*out,!=NULL*/)

TEMPL_UTF8_TO_UTF16_Z_UNSAFE(utf8_to_utf16_z_unsafe, utf16_char_t, Post_z);
TEMPL_UTF8_TO_UTF16_Z_UNSAFE(utf8_to_utf16x_z_unsafe, utf16_char_t, Post_z);
TEMPL_UTF8_TO_UTF16_Z_UNSAFE(utf8_to_utf16u_z_unsafe, utf16_char_unaligned_t, Empty);
TEMPL_UTF8_TO_UTF16_Z_UNSAFE(utf8_to_utf16ux_z_unsafe, utf16_char_unaligned_t, Empty);

#undef ANNS_UTF8_TO_UTF16_Z_UNSAFE
...
#ifdef SAL_DEFS_H_INCLUDED /* include "sal_defs.h" for the annotations */
#define ANNS_UTF8_TO_UTF16_UNSAFE \
A_Nonnull_all_args \
A_At(q, A_In_reads(n)) \
A_At(buf, A_Out) \
A_At(n, A_In_range(>,0))
...
#undef ANNS_UTF8_TO_UTF16_UNSAFE

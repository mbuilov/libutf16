...
#define utf8_to_utf32_z(q, b, sz)             utf8_to_utf32_z_(q, b, sz, /*determ_size:*/1)
#define utf8_to_utf32x_z(q, b, sz)            utf8_to_utf32x_z_(q, b, sz, /*determ_size:*/1)
#define utf8_to_utf32u_z(q, b, sz)            utf8_to_utf32u_z_(q, b, sz, /*determ_size:*/1)
#define utf8_to_utf32ux_z(q, b, sz)           utf8_to_utf32ux_z_(q, b, sz, /*determ_size:*/1)

#define utf8_to_utf32_z_partial(q, b, sz)     utf8_to_utf32_z_(q, b, sz, /*determ_size:*/0)
#define utf8_to_utf32x_z_partial(q, b, sz)    utf8_to_utf32x_z_(q, b, sz, /*determ_size:*/0)
#define utf8_to_utf32u_z_partial(q, b, sz)    utf8_to_utf32u_z_(q, b, sz, /*determ_size:*/0)
#define utf8_to_utf32ux_z_partial(q, b, sz)   utf8_to_utf32ux_z_(q, b, sz, /*determ_size:*/0)
...
/* same as utf8_to_utf32_z_size(), but changes (*q) on success:
  (*q) - points beyond the 0-terminator of input utf8 string */
#define utf8_to_utf32_z_size_e(q/*in,out,!=NULL*/)   utf8_to_utf32_z_(q, /*b:*/NULL, /*sz:*/0, /*determ_size:*/2)
#define utf8_to_utf32x_z_size_e(q/*in,out,!=NULL*/)  utf8_to_utf32x_z_(q, /*b:*/NULL, /*sz:*/0, /*determ_size:*/2)
#define utf8_to_utf32u_z_size_e(q/*in,out,!=NULL*/)  utf8_to_utf32u_z_(q, /*b:*/NULL, /*sz:*/0, /*determ_size:*/2)
#define utf8_to_utf32ux_z_size_e(q/*in,out,!=NULL*/) utf8_to_utf32ux_z_(q, /*b:*/NULL, /*sz:*/0, /*determ_size:*/2)
...
#define utf8_to_utf32(q, b, sz, n)             utf8_to_utf32_(q, b, sz, n, /*determ_size:*/1)
#define utf8_to_utf32x(q, b, sz, n)            utf8_to_utf32x_(q, b, sz, n, /*determ_size:*/1)
#define utf8_to_utf32u(q, b, sz, n)            utf8_to_utf32u_(q, b, sz, n, /*determ_size:*/1)
#define utf8_to_utf32ux(q, b, sz, n)           utf8_to_utf32ux_(q, b, sz, n, /*determ_size:*/1)

#define utf8_to_utf32_partial(q, b, sz, n)     utf8_to_utf32_(q, b, sz, n, /*determ_size:*/0)
#define utf8_to_utf32x_partial(q, b, sz, n)    utf8_to_utf32x_(q, b, sz, n, /*determ_size:*/0)
#define utf8_to_utf32u_partial(q, b, sz, n)    utf8_to_utf32u_(q, b, sz, n, /*determ_size:*/0)
#define utf8_to_utf32ux_partial(q, b, sz, n)   utf8_to_utf32ux_(q, b, sz, n, /*determ_size:*/0)

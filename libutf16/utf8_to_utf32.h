...
#define utf8_to_utf32x_z(q/*in,out,!=NULL*/, b/*in,out,!=NULL if sz>0*/, sz/*0?*/) \
	utf8_to_utf32x_z_(q, b, sz, /*determ_req_size:*/1)
...
#define utf8_to_utf32x_z_partial(q/*in,out,!=NULL*/, b/*in,out,!=NULL if sz>0*/, sz/*0?*/) \
	utf8_to_utf32x_z_(q, b, sz, /*determ_req_size:*/0)
...
/* determine the size (in utf32_char_t's) of resulting converted from
 ...
 returns 0 on error:
  ...
  (*q) - points beyond last valid utf8_char_t,
   . last valid utf8_char_t is _not_ 0 */
#define utf8_to_utf32x_z_size(q/*in,out,!=NULL*/) utf8_to_utf32x_z(q, NULL, 0)
...
#define utf8_to_utf32x(q/*in,out,!=NULL if n>0*/, b/*in,out,!=NULL if n>0 && sz>0*/, sz/*0?*/, n/*0?*/) \
	utf8_to_utf32x_(q, b, sz, n, /*determ_req_size:*/1)
...
/* same as utf8_to_utf32(), but if output buffer is not empty and is too small, do not
  determine its required size. */
#define utf8_to_utf32x_partial(q/*in,out,!=NULL if n>0*/, b/*in,out,!=NULL if n>0 && sz>0*/, sz/*0?*/, n/*0?*/) \
	utf8_to_utf32x_(q, b, sz, n, /*determ_req_size:*/0)
...
/* determine the size (in utf32_char_t's) of resulting buffer needed for converting 'n' utf8_char_t's to utf32 ones,
 ...
 returns 0 if 'n' is zero or there is an error:
  ...
  (*q) - points beyond last valid utf8_char_t,
   . last valid utf8_char_t is _not_ the last character of utf8 string */
/* Note: zero utf8_char_t is not treated specially, i.e. conversion do not stops */
#define utf8_to_utf32x_size(q/*in,out,!=NULL if n>0*/, n/*0?*/) utf8_to_utf32x(q, NULL, 0, n)
#define utf8_to_utf32_size(q/*in,out,!=NULL if n>0*/, n/*0?*/) utf8_to_utf32(q, NULL, 0, n)

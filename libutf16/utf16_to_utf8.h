...
* Copyright (C) 2018-2023 Michael M. Builov, https://github.com/mbuilov/libutf16
...
/*
  ...
  utf16{,u}{,x}_to_utf8{{,_z}{,_size,_partial,_unsafe},_z_size_e}
...
size_t name( \
	const it/*utf16_char_t,utf16_char_unaligned_t*/ **const LIBUTF16_RESTRICT w/*in,out,!=NULL*/, \
...
#define utf16_to_utf8_z(w, b, sz)             utf16_to_utf8_z_(w, b, sz, /*determ_size:*/1)
#define utf16x_to_utf8_z(w, b, sz)            utf16x_to_utf8_z_(w, b, sz, /*determ_size:*/1)
#define utf16u_to_utf8_z(w, b, sz)            utf16u_to_utf8_z_(w, b, sz, /*determ_size:*/1)
#define utf16ux_to_utf8_z(w, b, sz)           utf16ux_to_utf8_z_(w, b, sz, /*determ_size:*/1)

#define utf16_to_utf8_z_partial(w, b, sz)     utf16_to_utf8_z_(w, b, sz, /*determ_size:*/0)
#define utf16x_to_utf8_z_partial(w, b, sz)    utf16x_to_utf8_z_(w, b, sz, /*determ_size:*/0)
#define utf16u_to_utf8_z_partial(w, b, sz)    utf16u_to_utf8_z_(w, b, sz, /*determ_size:*/0)
#define utf16ux_to_utf8_z_partial(w, b, sz)   utf16ux_to_utf8_z_(w, b, sz, /*determ_size:*/0)
...
/* same as utf16_to_utf8_z_size(), but changes (*w) on success:
  (*w) - points beyond the 0-terminator of input utf16 string */
#define utf16_to_utf8_z_size_e(w/*in,out,!=NULL*/)   utf16_to_utf8_z_(w, /*b:*/NULL, /*sz:*/0, /*determ_size:*/2)
#define utf16x_to_utf8_z_size_e(w/*in,out,!=NULL*/)  utf16x_to_utf8_z_(w, /*b:*/NULL, /*sz:*/0, /*determ_size:*/2)
#define utf16u_to_utf8_z_size_e(w/*in,out,!=NULL*/)  utf16u_to_utf8_z_(w, /*b:*/NULL, /*sz:*/0, /*determ_size:*/2)
#define utf16ux_to_utf8_z_size_e(w/*in,out,!=NULL*/) utf16ux_to_utf8_z_(w, /*b:*/NULL, /*sz:*/0, /*determ_size:*/2)
...
/* convert 'n' utf16_char_t's to utf8 ones,
 ...
 returns number of stored utf8_char_t's:
  0     - if 'n' is zero, an invalid/incomplete utf16 character is encountered or utf16 string is too long,
...
size_t name( \
	const it/*utf16_char_t,utf16_char_unaligned_t*/ **const LIBUTF16_RESTRICT w/*in,out,!=NULL if n>0*/, \
...
#define utf16_to_utf8(w, b, sz, n)             utf16_to_utf8_(w, b, sz, n, /*determ_size:*/1)
#define utf16x_to_utf8(w, b, sz, n)            utf16x_to_utf8_(w, b, sz, n, /*determ_size:*/1)
#define utf16u_to_utf8(w, b, sz, n)            utf16u_to_utf8_(w, b, sz, n, /*determ_size:*/1)
#define utf16ux_to_utf8(w, b, sz, n)           utf16ux_to_utf8_(w, b, sz, n, /*determ_size:*/1)

#define utf16_to_utf8_partial(w, b, sz, n)     utf16_to_utf8_(w, b, sz, n, /*determ_size:*/0)
#define utf16x_to_utf8_partial(w, b, sz, n)    utf16x_to_utf8_(w, b, sz, n, /*determ_size:*/0)
#define utf16u_to_utf8_partial(w, b, sz, n)    utf16u_to_utf8_(w, b, sz, n, /*determ_size:*/0)
#define utf16ux_to_utf8_partial(w, b, sz, n)   utf16ux_to_utf8_(w, b, sz, n, /*determ_size:*/0)
...
const it/*utf16_char_t,utf16_char_unaligned_t*/ *name( \
	const it/*utf16_char_t,utf16_char_unaligned_t*/ *LIBUTF16_RESTRICT w/*!=NULL,0-terminated*/, \
...
void name( \
	const it/*utf16_char_t,utf16_char_unaligned_t*/ *LIBUTF16_RESTRICT w/*!=NULL*/, \
	utf8_char_t *const LIBUTF16_RESTRICT buf/*out,!=NULL*/, \
	const size_t n/*>0*/)
